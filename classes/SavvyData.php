...
include_once(_PS_MODULE_DIR_ . 'savvy/classes/SavvyTransaction.php');

class SavvyData extends ObjectModel
{
    public $id_savvy;
    ...
    public static function getByOrderRefence($orderReference)
    {
        ...
        if ($raw && isset($raw['id_savvy'])) {
            /** @noinspection PhpUnhandledExceptionInspection */
            return new self($raw['id_savvy']);
        }
